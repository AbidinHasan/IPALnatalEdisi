      ...
      <ul>
        ...
        <li class="dropdown" id="laporanDropdown">
          ...
          <div class="dropdown-content" role="menu" aria-label="Laporan">
            <a  onclick="stp()">Debit STP</a>
            <a  onclick="wwtp()">Debit WWTP</a>
            <a  onclick="internalLAB()">LAB Internal</a>
            <a  onclick="msds()">MSDS</a>
            <a  onclick="wi()">Work Instriction</a>
            <a onclick="usageMaterial()">Material Usage</a>
            <a onclick="klikarsip()">Arsip</a>
          </div>
        </li>
      </ul>
    </nav>
