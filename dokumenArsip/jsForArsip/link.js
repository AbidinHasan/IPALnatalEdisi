...
function usageMaterial() {
  loading();
  window.location.href = "../PenggunaanMaterial.html";
}
function Tahun2025() {
  loading();
...
function stp2025() {
  loading();
  window.location.href = "STParsip2025.html";
}
function wwtp2025() {
  loading();
  window.location.href = "WWTParsip2025.html";
}
function lab2025() {
  loading();
  window.location.href = "HasilLab2025.html";
}
function labex2025() {
  loading();
  window.location.href = "LabExternal2025.html";
}
function usageMaterial2025() {
  loading();
  window.location.href = "MaterialUsage2025.html";
}
